...
export default class Cart {
  ...
  renderProduct(product, count) {
    ...
    <div class="cart-product" data-product-id="${product.id}">
      <div class="cart-product__img">
        <img src="/ranking/assets/images/products/${product.image}" alt="product">
      </div>
        ...
        <div class="cart-product__price-wrap">
          <div class="cart-counter">
            <button type="button" class="cart-counter__button cart-counter__button_minus">
              <img src="/ranking/assets/images/icons/square-minus-icon.svg" alt="minus">
            </button>
            <span class="cart-counter__count">${count}</span>
            <button type="button" class="cart-counter__button cart-counter__button_plus">
              <img src="/ranking/assets/images/icons/square-plus-icon.svg" alt="plus">
            </button>
          </div>
  ...
  renderOrderForm() {
    return createElement(`<form class="cart-form">
      <h5 class="cart-form__title">Order</h5>
      <div class="cart-form__group cart-form__group_row">
        <input name="name" type="text" class="cart-form__input" placeholder="Name" required value="">
        <input name="email" type="email" class="cart-form__input" placeholder="Email" required value="">
        <input name="tel" type="tel" class="cart-form__input" placeholder="Phone" required value="">
      </div>
      <div class="cart-form__group">
        <input name="address" type="text" class="cart-form__input" placeholder="Address" required value="">
      </div>
    ...
    fetch("https://httpbin.org/post", {
      ...
      <div class="modal__body-inner">
        <p>
          ...
          We’ll notify you about picking up time shortly.<br>
          <img src="./ranking/assets/images/giphy.gif">
        </p>
      </div>
      `;
    });
